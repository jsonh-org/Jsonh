...
| Visual Studio | [JsonhVs](https://github.com/jsonh-org/JsonhVs) | [![Visual Studio Marketplace](https://img.shields.io/github/release/jsonh-org/JsonhVs.svg?label=vs%20marketplace)](https://marketplace.visualstudio.com/items?itemName=Joyless.jsonh-vs) | 🍬 | Highlighter
| GDExtension | [JsonhGdextension](https://github.com/jsonh-org/JsonhGdextension) | [![Godot Asset Store](https://img.shields.io/github/v/release/jsonh-org/JsonhGdextension.svg?label=Godot%20Asset%20Store&logo=godotengine)](https://store.godotengine.org/asset/joyless/jsonh) | 🍬 | Parser using JsonhCpp
...
| Godot | [JsonhTranslations](https://github.com/jsonh-org/JsonhTranslations) | [![Godot Asset Library](https://img.shields.io/github/v/release/jsonh-org/JsonhTranslations.svg?label=Godot%20Asset%20Store&logo=godotengine)](https://store.godotengine.org/asset/joyless/jsonh-translations) | 🍬 | Translation File Importer using JsonhCs
